// ============================================================
// Oficios60minutos — Asistente de preguntas frecuentes
// ============================================================
...
const FAQ_KB = [
  { keywords: ['como funciona', 'que es fixya', 'que es esto', 'de que trata', 'para que sirve'],
    answer: 'Oficios60minutos conecta a expertos del hogar verificados con quienes los necesitan. Publicas tu urgencia, recibes una cotización inmediata y confirmas con un técnico verificado — en menos de 60 minutos.' },
  ...
  { keywords: ['zonas', 'cobertura', 'donde', 'ciudades', 'ubicacion'],
    answer: 'Por ahora tenemos cobertura activa en las alcaldías Benito Juárez, Miguel Hidalgo, Cuauhtémoc, Coyoacán y Álvaro Obregón.' },
  ...
  { keywords: ['app', 'descargar', 'aplicacion', 'play store', 'app store'],
    answer: 'No necesitas descargar ninguna app. Oficios60minutos funciona directo desde el navegador, en computadora o celular.' },
  { keywords: ['registrar', 'crear cuenta', 'cuenta nueva', 'como me registro'],
    answer: 'Dale clic a "Crear cuenta" arriba a la derecha, elige si eres Cliente o Técnico, y listo — ya puedes usar Oficios60minutos.' },
  ...
  { keywords: ['comision', 'cuanto gana', 'ganancias', 'ticket promedio'],
    answer: 'Oficios60minutos retiene una comisión del 15% sobre cada servicio. El ticket promedio en la plataforma es de $800 MXN.' },
...
const FAQ_GREETING = '¡Hola! 👋 Soy el asistente de Oficios60minutos. Puedo ayudarte con preguntas sobre cómo funciona la plataforma, precios, zonas de cobertura y más. ¿Qué quieres saber?';
const FAQ_QUICK_QUESTIONS = [
  '¿Cómo funciona Oficios60minutos?',
