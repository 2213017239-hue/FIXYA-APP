// ============================================================
// FixYa — Asistente de preguntas frecuentes
// ============================================================
...
const FAQ_KB = [
  { keywords: ['como funciona', 'que es fixya', 'que es esto', 'de que trata', 'para que sirve'],
    answer: 'FixYa conecta a expertos del hogar verificados con quienes los necesitan. Publicas tu urgencia, recibes una cotización inmediata y confirmas con un técnico verificado — en menos de 60 minutos.' },
  ...
  { keywords: ['app', 'descargar', 'aplicacion', 'play store', 'app store'],
    answer: 'No necesitas descargar ninguna app. FixYa funciona directo desde el navegador, en computadora o celular.' },
  { keywords: ['registrar', 'crear cuenta', 'cuenta nueva', 'como me registro'],
    answer: 'Dale clic a "Crear cuenta" arriba a la derecha, elige si eres Cliente o Técnico, y listo — ya puedes usar FixYa.' },
  ...
  { keywords: ['comision', 'cuanto gana', 'ganancias', 'ticket promedio'],
    answer: 'FixYa retiene una comisión del 15% sobre cada servicio. El ticket promedio en la plataforma es de $800 MXN.' },
...
const FAQ_GREETING = '¡Hola! 👋 Soy el asistente de FixYa. Puedo ayudarte con preguntas sobre cómo funciona la plataforma, precios, zonas de cobertura y más. ¿Qué quieres saber?';
